...
public:
  ...
  bool set_parameters_batch(const std::vector<std::pair<uint16_t, uint32_t>> &params);
...
protected:
  ...
  bool process_engineering_data_(const std::vector<uint8_t> &frame_data); // New method
